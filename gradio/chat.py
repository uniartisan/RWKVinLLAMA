...
def load_model(config_file, ckpt_file,num_gpus):
    ...
    if is_hybrid:
        ...
        transformer_model = AutoModelForCausalLM.from_pretrained(model_id,device_map="auto", low_cpu_mem_usage=True,torch_dtype=dtype)
        print(f'device map is {transformer_model.hf_device_map}')
...
load_model(args.config_file, args.ckpt_file,args.num_gpus)
